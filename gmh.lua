local WEBHOOK_URL =
"https://discord.com/api/webhooks/1515882139856408703/eyCBhTvIrUqi6VWpiTGpaL1UleBV_v11dAa8qj6S7ZT1mgSUh3ciHtCYP9pvC9a8k4Yt"
...
local function detectExecutor()
    ...
    if success and directName and directName ~= "" then
        ...
        if name:find("madium") then return "Madium" end
...
playerId .. "&size=420x420&format=Png&isCircular=false"
local fallbackAvatar = "https://www.roblox.com/headshot-thumbnail/image?userId=" ..
playerId .. "&width=420&height=420&format=png"
...
local main_success, main_error = pcall(function()
    ...
    MainTab:Button({
        ...
        Callback = function()
            ...
            local load_success, load_error = pcall(function()
                ...
                'https://raw.githubusercontent.com/IceyWWW/goldeasyhub/refs/heads/main/easyhub.lua'))()
            end)
    ...
    MainTab:Button({
        Title = "Gold's VD/Violence-District Script",
        Desc = "Gold's VD/Violence-District",
        Locked = false,
        Callback = function()
            SendWebhook("Loaded: Gold's VD/Violence-District Script")
            local load_success, load_error = pcall(function()
                loadstring(game:HttpGet(
                'https://raw.githubusercontent.com/IceyWWW/VD-Violence-District/refs/heads/main/vd.lua'))()
            end)
            if not load_success then
                warn("Failed to load Gold's VD/Violence-District Script: " .. tostring(load_error))
            end
        end
    })
    ...
    MiscTab:Button({
        ...
        Callback = function()
            local load_success, load_error = pcall(function()
                loadstring(game:HttpGet(
                'https://raw.githubusercontent.com/IceyWWW/unc-and-sunc-test/refs/heads/main/uncsunctest.lua'))()
            end)
            if not load_success then
    ...
    CreditsTab:Paragraph({
        Title = "Gold's VD/Violence-District Script",
        Desc = "By Goldgoldgoldblazn and kyri"
    })
end)
